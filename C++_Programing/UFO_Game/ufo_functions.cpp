...
void greet()
{
  ...
  std::cout << "=============" << std::endl;
  std::cout << "Instructions: save your friend from alien abduction by guessing the letters in the codeword." << std::endl << std::endl;
}
